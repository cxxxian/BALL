...
public class TeslaTower : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Give it a bright cyan/electric blue color
    ...
    private void AttackElectricNova()
    {
        ...
        // Visual: Expanding Electric Nova Ring
    ...
    private IEnumerator SpawnNovaEffect(float radius)
    {
        ...
        sr.color = new Color(0f, 0.95f, 1f, 1f); // Electric Blue/Cyan
        ...
        Vector3 endScale = Vector3.one * (radius * 2f); // *2 because sprite is 1 unit, so scale matches diameter
        ...
        while (elapsed < duration)
        {
            ...
            Color c = sr.color;
            // High HDR intensity at start, fading to transparent
    ...
    private static Sprite CreateTeslaSprite()
    {
        ...
        for (int y = 0; y < size; y++)
        {
            for (int x = 0; x < size; x++)
            {
                ...
                // Cyberpunk Tesla look: Outer segmented ring, solid inner core, glowing crosshairs
                if (dist <= half - 2f)
                {
                    if (dist > half - 6f) 
                    {
                    ...
                    {
                        // Crosshairs connecting core and ring
    ...
    private static Sprite CreateNovaSprite()
    {
        ...
        tex.Apply();
        // Since size is 128 and PPU is 128, the sprite is exactly 1x1 world units.
